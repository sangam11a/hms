            ...
            <ul class="navbar-nav ms-auto">
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                        <li><a class="dropdown-item" href="../rooms/changepsd.php">Change Password</a></li>
                ...
                <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                    <div class="sb-sidenav-menu">
                        <div class="nav">
                            ...
                            <a class="nav-link" href="../rooms/dashboard_admin.php">
                                 <?php }
                                 else{?>
                            ...
                            <!-- <a class="nav-link" href="../rooms/schedule_booking.php">
                                <div class="sb-nav-link-icon"><i class="fas fa-building"></i></div>
                                Schedule Booking
                            </a> -->
                                </nav>
                            ...
                            <div class="collapse" id="collapseLayouts" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    <a class="nav-link" href="/hms/rooms/userslist.php">Users List</a>
                                    <a class="nav-link" href="/hms/rooms/roleadd.php">Role Add</a>
                                </nav>
                            </div>
                            <?php }?>
                    ...
                    <a class="nav-link collapsed" href="#" data-bs-toggle="collapse" data-bs-target="#collapseOrders" aria-expanded="false" aria-controls="collapseOrders">
                            ...
                            <a class="nav-link collapsed" href="#" data-bs-toggle="collapse" data-bs-target="#booking_details" aria-expanded="false" aria-controls="booking_details">
                                <div class="sb-nav-link-icon"><i class="fas fa-home"></i></div>
                                Booking
                                <div class="sb-sidenav-collapse-arrow"><i class="fas fa-angle-down"></i></div>
                            </a>
